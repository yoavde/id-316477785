...
const CreateUsers = (req,res,next)=> {
    var Q2 = "CREATE TABLE `users` (`username` varchar(255) NOT NULL,`password` varchar(50) NOT NULL,`fullname` varchar(70) DEFAULT NULL,PRIMARY KEY (`username`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;"
...
const InsertDataToTeachers = (req,res,next)=>{
    ...
    jsonObj.forEach(element => {
        var NewEntry = {
            ...
            "city" : element.city,
            "averagerank" : element.averagerank,
            "price" : element.price,
            "tel" : element.tel,
...
const ShowUsersTable = (req,res,next)=>{
    ...
    SQL.query(Q6, (err, mySQLres)=>{
        ...
        console.log(mySQLres,"showing users table");
        next();
    })};
    ...
    const ShowTeachersTable = (req,res,next)=>{
        ...
        SQL.query(Q5, (err, mySQLres)=>{
            ...
            console.log(mySQLres,"showing Teachers table");
            next();
        })};
